  ...
  objects: function() {
    this.objs = this.objs || {
      ...
      others: [
        ...
        // Model.Domain.BadGround.build({x: this.width*-0.14,  y: this.height*-0.21}, {width: this.width*-0.09, height: this.height*0.06}),
        // Model.Domain.BadGround.build({x: this.width*-0.03,  y: this.height*-0.00}, {width: this.width*-0.11, height: this.height*0.35}),
        // Model.Domain.BadGround.build({x: this.width*-0.15,  y: this.height*-0.14}, {width: this.width*0.20, height: this.height*-0.11}),
        // Model.Domain.BadGround.build({x: this.width*-0.20,  y: this.height*-0.21}, {width: this.width*0.03, height: this.height*0.04}),
        // Model.Domain.BadGround.build({x: this.width*-0.31,  y: this.height*-0.36}, {width: this.width*-0.08, height: this.height*-0.15}),
        // Model.Domain.BadGround.build({x: this.width*0.03,  y: this.height*-0.09}, {width: this.width*-0.01, height: this.height*0.13}),
        // Model.Domain.BadGround.build({x: this.width*0.32,  y: this.height*-0.15}, {width: this.width*-0.07, height: this.height*-0.04}),
        // Model.Domain.BadGround.build({x: this.width*0.01,  y: this.height*-0.17}, {width: this.width*0.03, height: this.height*0.05}),
        // Model.Domain.BadGround.build({x: this.width*0.03,  y: this.height*0.18}, {width: this.width*0.03, height: this.height*0.05}),
      ]
    };
    stage = this;
